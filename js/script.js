$(document).ready(function(){
	...
	function toggleSlide(item) {
		$(item).each(function(i) {
			$(this).on('click', function(e) {
				...
				$('.catalog-item__ul').eq(i).toggleClass('catalog-item__ul_active');
			});
		});
	};
	...
	$('input[name=phone]').mask("+7 (999) 999-99-99"); /* чтобы маска работала, необходимо удалить из html в name=phone type="number" */
